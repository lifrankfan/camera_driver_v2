...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_iic_output is
  ...
  signal \slv_regs[0][0]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \slv_regs[0][0]_i_2\ : label is "soft_lutpair0";
begin
...
\slv_regs[0][0]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
